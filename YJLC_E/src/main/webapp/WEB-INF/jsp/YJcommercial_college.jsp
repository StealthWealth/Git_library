...
<body>
	...
	<h3 class="w3_agile_head">盈+商学院</h3>
	...
	<div class="layui-tab layui-tab-card" style="height: 1600px">
		<ul class="layui-tab-title">
			<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
			<li class="layui-this"><font size="3">&nbsp;&nbsp;理财大讲堂&nbsp;&nbsp;</font></li>
			<li><font size="3">&nbsp;&nbsp;常见问题&nbsp;&nbsp;</font></li>
			<li><font size="3">&nbsp;&nbsp;帮助中心&nbsp;&nbsp;</font></li>
			<li><font size="3">&nbsp;&nbsp;操作指引&nbsp;&nbsp;</font></li>
		</ul>
		...
		<div class="layui-tab-content" style="height: 100%;">
			...
			<div class="layui-tab-item layui-show">
				<center>
					<div style="width: 700px" align="left">
						<br>
						<h3 align="center">理财大讲堂</h3>
						<br>
						<p>
							<font color="wathet" size="4">什么是投资理财?</font><br> 理财是理一生的财，不是解决燃眉之急的金钱问题而已。而是一个可持续循环的过程。
							理财是现金流量管理，每一个人一出生就需要用钱（现金流出）、也需要赚钱来产生现金流入。因此不管是否有钱，每一个人都需要理财。 理财也涵盖了风险管理。因为未来的更多流量具有不确定性，包括人身风险、财产风险与市场风险，都会影响到现金流入（收入中断风险）或现金流出（费用递增风险）。 <br>
							<br> <font color="wathet" size="4">如何投资理财?</font><br> 投资其实就是一种形式而已，但是随着人类社会不断的进步，社会发展中越来越多的人开始关注投资，而且投资知识也有人想了解。
							...
							<br>
							<br> <font color="wathet" size="4">投资理财一般步骤</font><br>
							...
							<br>
							<br> <font color="wathet" size="4">财富的4321定律</font><br>
							财富的4321定律：即财产的合理配置的比例是，家庭总收入的五分之二用于房贷等长期固定资产的投资；30%用于家庭日常生活开支；五分之一用于灵活的银行存款以备应急之需；剩下的少部分用于保险保障或者风险系数与收益系数都比较高的股票、期货投资。 <br>
							<br> <font color="wathet" size="4">财富的 72定律</font><br> 财富的
							72定律：投资理财所获得的收益，一般不取出，而继续投入理财本金，实现利滚利的高收益财，本金增值一倍所需要的时间等于72除以年收益率。假如在银行存款1万元，年利率是2%，那末经过多少年才能增值为2万元？只要用72除以2得36，便可=大概知道银行存款需36年才能翻番。 <br>
							<br>
							...
							<br>
							<br> 投资组合考虑的时候，应考虑到家庭资产的情况，风险程度，时间投资期限，变现能力，投资灵活性，都要进行综合考虑，保证在家庭有紧迫需求时能马上变换出需要的资金。风险忍受度原则即"生活风险忍受度"，保障本金是投资理财的重中之重，一切投资都需要遵守此规则。 <br>
							<br>
			...
			<div class="layui-tab-item ">
				<center>
					<div style="width: 700px" align="left">
						<br>
						<h3 align="center">常见问题</h3>
						<br>
						<p>
							<font color="wathet" size="4">什么是固定收益类理财产品?</font><br> 固定收益类理财产品，是指收益率和期限固定的产品。其特点是：收益固定、投资期限明确(一般为1年到2年)，通常都通过资产抵押、担保公司等来保证资金安全性，安全系数较高。
							<br>
							<br> <font color="wathet" size="4">如何选择固定收益类理财产品?</font><br>
							...
							<br>
							<br> <font color="wathet" size="4">保本型理财产品与固定收益产品有什么区别?</font><br>
							保本型理财产品，并不是说全保本，购买时除了关注产品的安全性、收益性，还要注意有些产品对本金的保证条件。比如有些产品只保证90%的本金;有些产品对本金的保证设有“保本期限”，比如在1年内本金能100%保证。倘若提前赎回，本金可能会受到损失。 <br>
							<br>
						</p>
					</div>
				</center>
			...
			<div class="layui-tab-item ">
				<center>
					<div style="width: 700px" align="left">
						<br>
						<h3 align="center">帮助中心</h3>
						<br>
						<p>
							<font color="wathet" size="4">官网操作对于浏览器有什么要求吗？</font><br> 建议使用IE、360浏览器、Chrome浏览器等主流浏览器登录。 <br>
							<br>
							<br> <font color="wathet" size="4">平台是正规的吗？</font><br> 放心，平台是合法合规的，具体包括以下6点： <br>
							<br> 1）资金流向保障 <br>
							...
							<br> <font color="wathet" size="4">忘记注册手机号怎么办？</font> <br>
			...
			<div class="layui-tab-item ">
				<center>
					<div style="width: 700px" align="left">
						<br>
						<h3 align="center">操作指引</h3>
						<br>
						<p>
							<font color="wathet" size="5">网站操作流程指引</font><br>
							<br> 如果您对盈+理财网站操作流程不太熟悉， 请参考为您制作的网站操作流程指引:&nbsp;&nbsp;&nbsp;
							<button class="layui-btn layui-btn-normal">
								<a href="#small-dialog" class="play-icon popup-with-zoom-anim"><font color="#ffffff">我来给你带路</font></a>
							</button>
						</p>
					</div>
				</center>
	...
	<jsp:include page="/WEB-INF/jsp/fontDown.jsp"></jsp:include>
</body>
