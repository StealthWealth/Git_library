	...
	<div>
		<form action="/YJLC_E/funds/updatefunds" method="post">
			<table border="0" width="80%">
				...
				<tr>
					<td colspan="2"><textarea id="myUeditor1" name="product_topic">${funds.product_topic }</textarea></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td colspan="2"><h1>▶产品要素</h1></td>
				</tr>
				<tr>
					<td colspan="2"><textarea id="myUeditor2" name="product_factor">${funds.product_factor }</textarea></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td colspan="2"><h1>▶私募合同</h1></td>
				</tr>
				<tr>
					<td colspan="2"><textarea id="myUeditor3" name="contract">${funds.contract }</textarea></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td width="3%">银行账户：</td>
					<td><input type="text" name="bank_account" style="width: 600px" value="${funds.bank_account }" />
						<div>
