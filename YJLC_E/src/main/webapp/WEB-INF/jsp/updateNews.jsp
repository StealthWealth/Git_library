...
<body>
	...
	<form id="formFile" method="post" enctype="multipart/form-data">
		<table border="1" class="table">
			<tr>
				...
				<td colspan="8" align="center"><c:if test="${not empty news.cPhoto }">
					...
					</div> <br> <input type="hidden" value="${news.id }" name="id"> <input type="hidden" value="${news.addTime }" name="addTime"></td>
			</tr>
			<tr>
		...
		<table width="100%" align="center" border="1">
			<tr align="center">
				<td align="center"><font class="text-primary" size="5">简介:</font> <script id="editor" type="text/plain" style="width:100%;height:100px;"
						name="info">${news.info}</script></td>
			</tr>
			<tr>
				<td><font class="text-primary" size="5">内容:</font>
