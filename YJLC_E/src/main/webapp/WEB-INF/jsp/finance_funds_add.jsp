	...
	<div>
		<form action="/YJLC_E/funds/savefunds" method="post" enctype="multipart/form-data">
			<table border="0" width="80%">
				...
				<tr>
					<td colspan="2"><h1>▶基金专题/关于基金</h1></td>
				</tr>
				<tr>
					<td colspan="2"><textarea id="myUeditor1" name="product_topic">${photo.product_topic }</textarea></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					...
					<td><img src="/YJLC_E/upload/${photo.product_manager_pic }" width="200" height="200" class="img-circle"><br>
						<div style="width: 100px;">
							<input type="hidden" name="product_manager_pic" value="${photo.product_manager_pic }"> <input type="file"
								name="file" onchange="upload()"><br>
						</div></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr>
					<td colspan="2"><h1>▶基金经理详情</h1></td>
				</tr>
				<tr>
					<td colspan="2"><textarea id="myUeditor2" name="product_manager">${photo.product_manager }</textarea></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td colspan="2"><h1>▶合同内容</h1></td>
				</tr>
				<tr>
					<td colspan="2"><textarea id="myUeditor3" name="contract">${photo.contract }</textarea></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td width="3%">银行账户：</td>
					<td><input type="text" name="bank_account" style="width: 600px" value="${photo.bank_account }" />
						<div>
							<font color="#FF00FF">例：招商银行杭州高新支行|1234 5678 1234 123|杭州吉威投资管理有限公司</font>
						</div></td>
				</tr>
				<tr>
