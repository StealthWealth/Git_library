...
<table height="160" class="peopleInfo" width="970" border="0" cellspacing="0" cellpadding="0">
    <tbody><tr>
        ...
        <td align="right">
            <a href="/YJLC_E/users/tuile" class="loginOut"><span class="iconfont"></span>安全退出</a>
        </td>
    </tr>
</tbody></table>
<div class="countBox">
...
<div class="adminLeft">
    ...
    <ul>
        ...
        <li><a id="member_center_menu_bbinInfo_record" href="/YJLE_E/users/listSBPR?mid=${member.id}"><em class="iconfont red"></em>体验金记录</a></li>
    </ul>
    <h2>我的账户</h2>
    <ul>
