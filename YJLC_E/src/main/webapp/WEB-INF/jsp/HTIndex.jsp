...
<link rel="stylesheet" type="text/css" href="/YJLC_E/static/h-ui/css/H-ui.min.css" />
<link rel="stylesheet" type="text/css" href="/YJLC_E/static/h-ui.admin/css/H-ui.admin.css" />
<link rel="stylesheet" type="text/css" href="/YJLC_E/lib/Hui-iconfont/1.0.8/iconfont.css" />
<link rel="stylesheet" type="text/css" href="/YJLC_E/static/h-ui.admin/skin/default/skin.css" id="skin" />
<link rel="stylesheet" type="text/css" href="/YJLC_E/static/h-ui.admin/css/style.css" />
<!--[if IE 6]>
...
<body>
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			<dt>
				<i class="Hui-iconfont">&#xe616;</i> 理财产品<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
		...
		<dl id="menu-picture">
			<dt>
				<i class="Hui-iconfont">&#xe616;</i> 学院管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a href="/YJLC_E/listNews" title="学院管理">资讯分类</a></li>
					<li><a href="college_Consultation_Administration.jsp" title="学院管理">资讯管理</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu-picture">
			<dt>
				<i class="Hui-iconfont">&#xe616;</i> 盈+管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
	...
	<section class="Hui-article-box"> <nav class="breadcrumb"> <i class="Hui-iconfont"></i> <a href="/" class="maincolor">首页</a> <span
		class="c-999 en">&gt;</span> <span class="c-666">我的桌面</span> <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
	...
	<div class="Hui-article">
		...
		<p>
			...
			&copy;2015 H-ui.admin 3.0 All Rights Reserved.<br> 本后台系统由<a href="http://www.h-ui.net/" target="_blank" title="H-ui前端框架">H-ui前端框架</a>提供前端技术支持
	...
	<script type="text/javascript" src="/YJLC_E/static/h-ui.admin/js/H-ui.admin.page.js"></script>
