...
<body>
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-article">
			...
			<dd style="display: block">
				<ul>
					<li class="current"><a href="college_Consultation_Type.jsp"
						title="学院管理">资讯分类</a></li>
	...
	学院管理 <span class="c-gray en">&gt;</span> 资讯分类 <a
	...
	<script type="text/javascript"
		src="/YJLC_E/lib/jquery/1.9.1/jquery.min.js"></script>
