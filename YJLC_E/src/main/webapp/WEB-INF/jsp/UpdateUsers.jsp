...
<body>
	...
	<div id="sidebar" class="nav-collapse">
		...
		<div class="leftside-navigation">
			<ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu"><a class="active" href="javascript:;"> <i class="fa fa-th"></i> <span>系统管理</span>
				</a>
					<ul class="sub">
	...
	</aside> <section id="main-content"> <section class="wrapper"> <!-- 内容开始 -->
	<style>
#id {
	float: top;
}
	...
	<div style="width: 100%">
		<form action="/YJLC_E/users/updateu?id=${users.id }" method="post">
			用户名 <input type="text" name="user_name" value="${users.user_name }" readonly> <br> 密码 <input type="password" name="password"
				value="${users.password }"> <br> 手机号 <input type="text" name="mobile_Phone" value="${users.mobile_Phone }"> <br> <input
	...
	<script src="js/jquery.slimscroll.js"></script> <script src="/YJLC_E/js/jquery.nicescroll.js"></script> <!--[if lte IE 8]><script language="javascript" type="text/javascript" src="js/flot-chart/excanvas.min.js"></script><![endif]-->
