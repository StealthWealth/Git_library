...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<!--付款   原跳转alipay.trade.page.pay.jsp -->
		<form name="alipayment" action="/YJLC_E/alipay/alipay_pag" method="post" target="_blank">
			...
			<div id="body1" class="show" name="divcontent">
				...
				<dl class="content">
					...
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject"  value="Y+充值"  />
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
