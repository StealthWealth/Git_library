	...
	<div>
		<form action="/YJLC_E/subject/savesubject" method="post" enctype="multipart/form-data">
			<table border="0" width="100%">
				...
				<tr>
					<td colspan="4">
						<textarea id="myUeditor1" name="comment"></textarea>
					</td>
				</tr>
				<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr>
				...
				<tr>
					<td colspan="4">
						<textarea id="myUeditor2" name="projectDetails"></textarea>
					</td>
				</tr>
				<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr>
				...
				<tr>
					<td colspan="4">
						<textarea id="myUeditor3" name="safetyControl"></textarea>
					</td>
				</tr>
				<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr>
