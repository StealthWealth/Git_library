...
<body>
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-article">
			...
			<dd style="display: block">
				<ul>
					<li class="current"><a href="/YJLC_E/listAuditingAll" title="会员管理">账号管理</a></li>
					<li><a href="vip_examine.jsp" title="会员管理">理财师审核</a></li>
					<li><a href="vip_Bangker.jsp" title="会员管理">绑卡管理</a></li>
					<li><a href="/YJLC_E/vip_plan" title="会员管理">付息计划</a></li>
	...
	会员管理 <span class="c-gray en">&gt;</span> 账号管理 <a
	...
	<div class="Hui-article">
		...
		<div class="mt-20" align="center">
			<form action="/Test2/listAuditingAll" method="post">
				<table>
					<tr>
						<td>用户名:</td>
