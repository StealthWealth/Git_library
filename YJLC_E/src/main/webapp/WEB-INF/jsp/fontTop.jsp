...
-->
	...
	<script src="/YJLC_E/font/jQuer_GunDong/jquery-1.10.2.js"></script>
	<script src="/YJLC_E/font/jQuer_GunDong/jquery.min.js"></script>
		...
		<div class="agileits_modal_body">
			<form action="/YJLC_E/users/MemberSignUp" method="post">
				<div class="agileits_w3layouts_user">
					<i class="fa fa-user" aria-hidden="true"></i> <input type="text" name="name" placeholder="用户名" required="">
				</div>
				<div class="agileits_w3layouts_user">
					<i class="fa fa-key" aria-hidden="true"></i> <input type="password" name="password" placeholder="密码" required="">
				</div>
			...
			<h5>
				没有一个账户吗? <a href="#small-dialog1" class="play-icon popup-with-zoom-anim">快速注册</a>
			</h5>
		</div>
	</div>
	...
	<div id="small-dialog1" class="mfp-hide w3ls_small_dialog wthree_pop">
		...
		<div class="agileits_modal_body">
			<form action="/YJLC_E/users/MemberSignIn" method="post">
				<h4>15秒快速注册 :</h4>
				<div class="agileits_w3layouts_user">
					<i class="fa fa-user" aria-hidden="true"></i> <input type="text" name="name" placeholder="用户名(需实名注册)" required="">
				</div>
				<div class="agileits_w3layouts_user">
					<i class="fa fa-volume-control-phone" aria-hidden="true"></i> <input type="text" name="mobile_Phone" placeholder="手机号">
				</div>
				...
				<br>
				<div class="agileits_w3layouts_user">
					<i class="fa fa-envelope-o" aria-hidden="true"></i> <input type="email" name="Email" placeholder="Email">
				</div>
				<br />
				...
				<div class="agileits_w3layouts_user">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
						id="code" class="nocode">验证码</span>
				</div>
				<br>

				<div class="agileits_w3layouts_user">
					<i class="fa fa-mobile-phone"></i> <input type="text" name="手机验证码" placeholder="获取手机验证码" style="width: 250px;">&nbsp;
				...
				<br>
				<div class="agileits_w3layouts_user">
					<i class="fa fa-comment-o"></i> <input type="text" name="qqNumber" placeholder="qq号码">
				</div>
				<div class="agileinfo_subscribe">
					<div class="check">
			...
			<h5>
				我已注册现在就 <a href="#small-dialog" class="play-icon popup-with-zoom-anim">登录</a>
			</h5>
		</div>
	</div>
