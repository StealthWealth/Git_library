...
<body>
			...
			<ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu"><a class="active" href="javascript:;"> <i class="fa fa-th"></i> <span>系统管理</span>
					...
					<ul class="sub">
						...
						<li><a class="active" href="system_Password.jsp">密码修改</a></li>
	...
	</aside> <section id="main-content"> <section class="wrapper"> 12131 </section> </section> <script src="/YJLC_E/js/bootstrap.js"></script> <script
		src="/YJLC_E/js/jquery.dcjqaccordion.2.7.js"></script> <script src="/YJLC_E/js/scripts.js"></script> <script src="/YJLC_E/js/jquery.slimscroll.js"></script>
