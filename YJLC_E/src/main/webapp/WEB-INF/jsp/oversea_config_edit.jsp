	...
	<div>
		<form action="/YJLC_E/config/updateconfig" method="post" enctype="multipart/form-data">
			<table border="0" width="100%">
				...
				<tr>
					<td width="10%">图标：</td>
					<td><img src="/YJLC_E/${oversea_config.oversea_icon }" width="200" height="200" class="img-circle"><br>
						<div style="width: 100px;">
							<input type="hidden" name="oversea_icon" value="${oversea_config.oversea_icon }"> <input type="file" name="file" onchange="upload()"><br>
						</div></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr>
					<td width="10%">子标题：</td>
					<td><input type="text" name="child_title" value="${oversea_config.child_title }" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td width="10%">描述：</td>
					<td><input type="text" name="description" value="${oversea_config.description }" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td width="10%">用户群体：</td>
					<td><input type="text" name="user_type" value="${oversea_config.user_type }" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td width="10%">排序值：</td>
					<td><input type="number" name="sortColum" value="${oversea_config.sortColum }" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td colspan="2"><textarea id="myUeditor" name="content">${oversea_config.content }</textarea></td>
				</tr>
				<tr>
