...
<script type="text/javascript" charset="utf-8"
	src="/YJLC_E/js/ueditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8"
	src="/YJLC_E/js/ueditor/ueditor.all.min.js"></script>
<!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
<!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
<script type="text/javascript" charset="utf-8"
	src="/YJLC_E/js/ueditor/lang/zh-cn/zh-cn.js"></script>
...
<body>
			...
			<input type="hidden" name="folder_id" value="${subject.folder_id }" />
				<tr>
					...
					<td><input type="text" name="serial_no"
						value="${subject.serial_no }" /></td>
				</tr>
				<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr>
					<td width="10%">起投金额(元)：</td>
					<td><input type="text" name="floor_amount"
						value="${subject.floor_amount }" /></td>
					<td width="10%">年化率(%)：</td>
					<td><input type="text" name="year_rate"
						value="${subject.year_rate }" /></td>
				</tr>
				<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr>
					<td width="10%">状态：</td>
				...
				<tr>
					...
					<td><input type="text" name="borrowername"
						value="${subject.borrowername }" /></td>
					<td width="10%">类型：</td>
					<td>
						<select name="type">
				...
				<tr>
					<td width="10%">购买人数：</td>
					<td><input type="text" name="bought"
						value="${subject.bought }" /></td>
				...
				<tr>
					<td colspan="4">
						<textarea id="myUeditor1" name="comment">${subject.comment }</textarea>
					</td>
				</tr>
				<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr>
				...
				<tr>
					<td colspan="4">
						<textarea id="myUeditor2" name="projectDetails">${subject.projectDetails }</textarea>
					</td>
				</tr>
				<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr>
				...
				<tr>
					<td colspan="4">
						<textarea id="myUeditor3" name="safetyControl">${subject.safetyControl }</textarea>
					</td>
				</tr>
				<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr>
	...
	<script src="/YJLC_E/js/jquery.scrollTo.js"></script> <script
